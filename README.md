...
| `PrivilegedEligibilitySchedule.Read.AzureADGroup`      | Graph    | [List eligible group assignments](https://learn.microsoft.com/graph/api/privilegedaccessgroupeligibilityschedule-filterbycurrentuser) (alternative — Read variant accepted)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `PrivilegedEligibilitySchedule.ReadWrite.AzureADGroup` | Graph    | [List eligible group assignments](https://learn.microsoft.com/graph/api/privilegedaccessgroupeligibilityschedule-filterbycurrentuser) (alternative — Read variant accepted)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `PrivilegedAssignmentSchedule.Read.AzureADGroup`       | Graph    | [List active group assignments](https://learn.microsoft.com/graph/api/privilegedaccessgroupassignmentschedule-filterbycurrentuser) (alternative — Read variant accepted); [List my group activation requests / list group approval queue](https://learn.microsoft.com/graph/api/privilegedaccessgroupassignmentschedulerequest-filterbycurrentuser) (alternative — Read variant accepted)                                                                                                                                                                                                                                                                    |
| `PrivilegedAssignmentSchedule.ReadWrite.AzureADGroup`  | Graph    | [List active group assignments](https://learn.microsoft.com/graph/api/privilegedaccessgroupassignmentschedule-filterbycurrentuser) (alternative — Read variant accepted); [List my group activation requests / list group approval queue](https://learn.microsoft.com/graph/api/privilegedaccessgroupassignmentschedulerequest-filterbycurrentuser) (alternative — Read variant accepted); [Submit group activation/deactivation schedule request](https://learn.microsoft.com/graph/api/privilegedaccessgroup-post-assignmentschedulerequests); [Approve or deny a group activation request](https://learn.microsoft.com/graph/api/approval-get)            |
...
| `RoleEligibilitySchedule.Read.Directory`               | Graph    | [List eligible Entra role assignments](https://learn.microsoft.com/graph/api/unifiedroleeligibilityschedule-filterbycurrentuser) (alternative — Read variant accepted)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `RoleEligibilitySchedule.ReadWrite.Directory`          | Graph    | [List eligible Entra role assignments](https://learn.microsoft.com/graph/api/unifiedroleeligibilityschedule-filterbycurrentuser) (alternative — Read variant accepted)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `RoleAssignmentSchedule.Read.Directory`                | Graph    | [List active Entra role assignments](https://learn.microsoft.com/graph/api/unifiedroleassignmentschedule-filterbycurrentuser) (alternative — Read variant accepted); [List my Entra role activation requests / list Entra approval queue](https://learn.microsoft.com/graph/api/unifiedroleassignmentschedulerequest-filterbycurrentuser) (alternative — Read variant accepted)                                                                                                                                                                                                                                                                              |
| `RoleAssignmentSchedule.ReadWrite.Directory`           | Graph    | [List active Entra role assignments](https://learn.microsoft.com/graph/api/unifiedroleassignmentschedule-filterbycurrentuser) (alternative — Read variant accepted); [List my Entra role activation requests / list Entra approval queue](https://learn.microsoft.com/graph/api/unifiedroleassignmentschedulerequest-filterbycurrentuser) (alternative — Read variant accepted); [Submit Entra role activation/deactivation schedule request](https://learn.microsoft.com/graph/api/rbacapplication-post-roleassignmentschedulerequests); [Approve or deny an Entra role activation request (BETA)](https://learn.microsoft.com/graph/api/beta/approval-get) |
